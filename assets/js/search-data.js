...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/CV_LianchengGong.pdf";
          },
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-new-preprint-on-zero-shot-iterative-formalization-and-planning",
          title: 'New preprint on zero-shot iterative formalization and planning',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/2025-05-20-paper-arxiv.html";
            },},{id: "news-cra-wp-grad-cohort-workshop-scholarship",
          title: 'CRA-WP Grad Cohort Workshop Scholarship',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/2026-03-07-cra.html";
            },},{id: "news-paper-accepted-at-icwsm-2026",
